...
module Mrg
  module Grid
    module Config
      module Shell
        class DeleteUser < ::Mrg::Grid::Config::Shell::Command
          ...
          def self.description
            "Deletes Wallaby role information for a broker user."
          end
        
          def init_option_parser
            # Edit this method to generate a method that parses your command-line options.
            OptionParser.new do |opts|
              opts.banner = "Usage:  wallaby #{self.class.opname} USERNAME\n#{self.class.description}"
          ...
          def ensure_args(*args)
            ...
            unless args.length == 1
              exit!(1, "you must specify a username")
            end
          ...
          def act
            ...
            store.del_user(@username, options)
            return 0
          end
        end
      end
